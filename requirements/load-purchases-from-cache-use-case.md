...
O sistema deve buscar compras existentes usando a key fornecida.

### **FR2 — Retornar lista vazia quando não houver dados**
Se a key não existir no cache, deve retornar uma lista vazia.

### **FR3 — Propagar erros**
Qualquer erro na operação `fetch` deve ser repassado ao chamador.
